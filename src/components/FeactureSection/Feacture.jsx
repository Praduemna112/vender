  ...
  return (
    <>
      ...
      <div className="bg-gray-100 py-12 px-6 md:px-20 rounded-lg relative">
        <div
          className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-center mt-12 text-gray-700"
          data-aos="fade-up"
        >
          {[
            ...
            ["🏷️", "Branded, curated, and nutritious range of meals, snacks and beverages"]
          ].map(([icon, title], index) => (
            <div key={index} className="transition-transform transform hover:scale-105 duration-300">
              <span className="text-orange-500 text-5xl">{icon}</span>
      ...
      <div className="bg-white text-gray-900 px-6 md:px-20 py-12">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-8" data-aos="fade-up">
          <img
            src={vendingMachine}
            alt="Vending Machine"
        ...
        {/* Section 2 - Beverages */}
        <div className="flex flex-col sm:flex-row items-center gap-2" data-aos="fade-up">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-2" data-aos="fade-up">
          <div className="w-full sm:w-1/2 sm:ml-28 pr-4 sm:pr-8">
            ...
            <h3 className="text-lg font-semibold mb-3">
              Allow Vendiman to manage your pantry supplies through Smart Micro Retail Solutions.
            </h3>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-14">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 w-full sm:w-2/3 bg-white shadow-md p-14 rounded-lg">
              {[
                ...
                <div className="text-center" key={i} data-aos="fade-up" data-aos-delay={i * 100}>
                  <span className="text-orange-500 text-5xl">{icon}</span>
        ...
        {/* Final Heading */}
        <div className="bg-white text-gray-900 px-6 md:px-20 py-12" data-aos="fade-up">
