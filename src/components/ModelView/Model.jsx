...
import GalaxyModel from "../ModelView/GalaxyModel/GalaxyModel"; // Importing GalaxyModel data
...
const FeatureCard = ({ img, title, desc }) => (
  <div className="bg-white shadow-md rounded-xl overflow-hidden border border-gray-200 hover:shadow-lg transition duration-300">
...
// All model data (Galaxy removed from here)
const models = [
  GalaxyModel, // imported from GalaxyModel.jsx
  NovaModel,
  OrionModel,
];
