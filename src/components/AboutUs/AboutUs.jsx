        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-10">
          ...
          <div className="w-full md:w-1/2 mt-8 md:mt-0">
            ...
            <p className="text-base sm:text-lg md:text-xl leading-relaxed">
              PTM Machines is recognized as India’s premier provider of Instant
              Commerce, offering sophisticated Smart Retail Solutions
              specifically designed for the food, beverage, and related sectors.
              Our mission is to enhance daily convenience by delivering
              solutions that are more intelligent, secure, and widely
              accessible. At Vendoring, we are steadfastly committed to
              delivering superior service and operational excellence to our
              clientele. Through our innovative and world-class offerings, we
              endeavor to ensure the highest standards of quality and customer
              experience.
            </p>
        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-10">
          <div className="w-full md:w-1/2">
            ...
            <ul className="list-disc pl-5 space-y-3 text-base sm:text-lg md:text-xl leading-relaxed">
              <li>
                <strong>VISION:</strong> To establish ourselves as India’s
                leading authority in Instant Commerce through advanced Smart
                Retail Solutions, specifically within the Food & Beverage sector
                and related industries.
              </li>

              <li>
                <strong>MISSION:</strong> To enhance everyday convenience by
                providing solutions that are more accessible, intelligent, and
                secure. We remain steadfastly consumer-centric, driven by data
                insights, and committed to upholding strong ethical values in
                all our endeavors.
              </li>
              <Link to="/contact" className="mb-4 block">
                <button className="bg-gradient-to-r from-pink-500 via-red-400 to-orange-400 text-white font-semibold py-2 px-8 sm:px-10 rounded-full shadow-lg transform transition-all duration-300 hover:scale-110 hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-pink-300">
